...
|       |   |-- Baseline/
|       |   |-- Features/CART_cv5_feat.R  # Mejor CART (top-40 vars RF)
|       |   |-- Balance/
...
|           |-- XGB_001.R
|           |-- XGB_007.R            # Mejor XGB (92 vars, sin Bogotá)
|
|-- 02_outputs/
...
| 3.1 | `LPM_003A.R` | Modelo de Probabilidad Lineal con class_weights, 81 variables. Incluye selección de variables y comparación de 5 técnicas de balanceo. | 1 min |
...
| 3.5 | `RF_006.R` | Random Forest (ranger, tuning de hiperparámetros, comparación de 5 técnicas de balanceo). | 22 min |
| 3.6 | `XGB_007.R` | XGBoost (búsqueda aleatoria de HP, sin variables construidas, sin Bogotá). | 4 min |
| | **Total** | | **~60 min** |
...
|---------|--------|-----------|-----------|---------|-----------|--------|---------|-----------|
| 1 | XGB_007 | XGBoost | 92 | 0.741 | 0.701 | 0.786 | 0.942 | 0.37 |
...
| 5 | CART_RF_top40 | CART | 40 | 0.674 | 0.670 | 0.677 | 0.886 | 0.29 |
| 6 | NB_RF_top20 | Naive Bayes | 20 | 0.561 | 0.421 | 0.843 | 0.861 | 0.95 |

## Mapeo: Scripts a Figuras de las Slides

### Deck 1 (Best Model Deep Dive): XGB_007

| Slide | Contenido | Fuente |
|-------|-----------|--------|
| Visión General del Mejor Modelo | Especificación XGB_007 + métricas | `02_outputs/model_registry.csv` |
| Diagnóstico: Errores del Modelo | Confusion matrix, FN vs FP | `02_outputs/models/XGBoost/XGB_007/` |
| Balance Precisión-Recall y Threshold | Curva threshold, justificación th=0.37 | `02_outputs/models/XGBoost/XGB_007/threshold.png` |
...
|-------|-----------|--------|
| Visión General del Mejor Modelo | Especificación XGB_007 + métricas | `02_outputs/model_registry.csv` |
| Diagnóstico: Errores del Modelo | Confusion matrix XGB_007 | `02_outputs/models/XGBoost/XGB_007/` |
| Balance Precisión-Recall y Threshold | Justificación th=0.37 | `02_outputs/models/XGBoost/XGB_007/threshold.png` |
...
| Deep Dive: XGB vs Random Forest | Tabla + ROC comparativo | `02_outputs/models/XGBoost/XGB_007/roc.png`, `02_outputs/models/RandomForest/RF_006/roc.png` |
| Por Qué XGBoost Supera al RF | Boosting vs bagging, regularización, threshold | Síntesis |
| Deep Dive: XGB vs Elastic Net | Tabla comparativa + ROC | `02_outputs/models/XGBoost/XGB_007/roc.png`, `02_outputs/models/EN/Baseline/EN_001A/` |
...
5. **Selección de variables**: El ranking de importancia por permutación del RF se usó para crear subconjuntos (top-20/40/60) evaluados en todos los algoritmos.

## Competencia Kaggle

- Competencia: Poverty Prediction Challenge (MECA 4107)
- Mejor F1 público: XGB_007
