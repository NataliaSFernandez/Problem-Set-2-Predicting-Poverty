...
#   El modelo conserva zona, dummies regionales, doble_ingreso,
...
# El modelo queda con: zona,, costa_caribe, region_pacifico, eje_cafetero,
...
VARS_EXCLUIR_B <- c(
  "id", "pobre",
  # ciudad y dpto: muchos niveles. zona + dummies regionales cubren
